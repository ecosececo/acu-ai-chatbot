...
TGI_BASE_URL = os.environ.get("TGI_BASE_URL", "http://tgi-gemma4:80")
GROQ_API_KEY = os.environ.get("GROQ_API_KEY", "")
GROQ_BASE_URL = os.environ.get("GROQ_BASE_URL", "https://api.groq.com/openai/v1")
LLM_PROVIDER = os.environ.get("LLM_PROVIDER", "tgi").lower()
LLM_MODEL = os.environ.get("LLM_MODEL", "qwen3.5")
OLLAMA_NUM_GPU = int(os.environ.get("OLLAMA_NUM_GPU", "0"))
EMBEDDING_MODEL = os.environ.get("EMBEDDING_MODEL", "nomic-embed-text")
EMBEDDING_DIMENSIONS = int(os.environ.get("EMBEDDING_DIMENSIONS", "1024"))  # bge-m3 = 1024
...
# Web search is disabled by default — enable via env var when needed
WEB_SEARCH_ENABLED = os.environ.get("WEB_SEARCH_ENABLED", "False").lower() in ("true", "1", "yes")
WEB_SEARCH_THRESHOLD = float(os.environ.get("WEB_SEARCH_THRESHOLD", "0.10"))
